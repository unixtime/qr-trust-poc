...
export const en = {
  ...
  "lab.scanFeedback.note.unavailable":
    "The evidence store is not answering, so scans cannot be reported back here right now. {error}",
  ...
  "lab.scanFeedback.destination.opened": "Opened by the scanner",
  "lab.scanFeedback.destination.cancelled": "Cancelled by the scanner",
