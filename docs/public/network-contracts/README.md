...
Every entry links to the contract itself. Schemas, the reference SQL, and the
`.example` files are served as-is; the `.md` contracts are published pages.

- [`root-manifest.schema.json`](root-manifest.schema.json)
- [`delegated-authority.schema.json`](delegated-authority.schema.json)
- [`issuer-record.schema.json`](issuer-record.schema.json)
- [`destination-policy.schema.json`](destination-policy.schema.json)
- [`revocation-status-event.schema.json`](revocation-status-event.schema.json)
- [`verifier-cache-entry.schema.json`](verifier-cache-entry.schema.json)
- [`scanner-decision.schema.json`](scanner-decision.schema.json)
- [`runtime-safety-observation.schema.json`](runtime-safety-observation.schema.json)
- [`deployment-readiness-report.schema.json`](deployment-readiness-report.schema.json)
- [`deployment-readiness-bundle.schema.json`](deployment-readiness-bundle.schema.json)
- [`verifier-profile.schema.json`](verifier-profile.schema.json)
- [`scanner-fleet-evidence.schema.json`](scanner-fleet-evidence.schema.json)
- [`ios-provider-profile-evidence.schema.json`](ios-provider-profile-evidence.schema.json)
- [`cross-surface-qr-evidence.schema.json`](cross-surface-qr-evidence.schema.json)
- [`reference-network-adoption-stage.schema.json`](reference-network-adoption-stage.schema.json)
- [`signing-custody-audit-export.schema.json`](signing-custody-audit-export.schema.json)
- [`worker-operations-evidence.schema.json`](worker-operations-evidence.schema.json)
- [`restore-automation-evidence.schema.json`](restore-automation-evidence.schema.json)
- [`packaged-deployment-approval-evidence.schema.json`](packaged-deployment-approval-evidence.schema.json)
- [`operator-evidence-index.schema.json`](operator-evidence-index.schema.json)
- [`production-evidence-requirements.schema.json`](production-evidence-requirements.schema.json)
- [`event-envelope.schema.json`](event-envelope.schema.json)
- [`key-rotation-policy.md`](key-rotation-policy.md)
- [`signer-recovery-runbook.md`](signer-recovery-runbook.md)
- [`managed-signing-custody-deployment-policy.md`](managed-signing-custody-deployment-policy.md)
- [`signing-custody-audit-export.md`](signing-custody-audit-export.md)
- [`artifact-publication-runbook.md`](artifact-publication-runbook.md)
- [`postgres-migration-deployment-policy.md`](postgres-migration-deployment-policy.md)
- [`reference-postgres-schema.sql`](reference-postgres-schema.sql)
- [`nats-subjects.md`](nats-subjects.md)
- [`scan-time-validation-sequence.md`](scan-time-validation-sequence.md)
- [`runtime-safety-provider-deployment-policy.md`](runtime-safety-provider-deployment-policy.md)
- [`deployment-readiness-operator-guide.md`](deployment-readiness-operator-guide.md)
- [`scanner-decision-http-runtime.md`](scanner-decision-http-runtime.md)
- [`verifier-profile-distribution.md`](verifier-profile-distribution.md)
- [`scanner-fleet-evidence.md`](scanner-fleet-evidence.md)
- [`ios-provider-profile-evidence.md`](ios-provider-profile-evidence.md)
- [`cross-surface-qr-evidence.md`](cross-surface-qr-evidence.md)
- [`reference-network-adoption-stage.md`](reference-network-adoption-stage.md)
- [`worker-operations-evidence.md`](worker-operations-evidence.md)
- [`restore-automation-evidence.md`](restore-automation-evidence.md)
- [`packaged-deployment-approval-evidence.md`](packaged-deployment-approval-evidence.md)
- [`operator-evidence-index.md`](operator-evidence-index.md)
- [`production-evidence-requirements.md`](production-evidence-requirements.md)
- [`production-evidence-private-handoff.md`](production-evidence-private-handoff.md)
- [`production-evidence-closure-bundle.md`](production-evidence-closure-bundle.md)
- [`production-adoption-gap-map.md`](production-adoption-gap-map.md)
- [`deployment-readiness.evidence.example.json`](deployment-readiness.evidence.example.json)
- [`deployment-readiness.production.env.example`](deployment-readiness.production.env.example)
- [`reference-network-adoption.evidence.example.json`](reference-network-adoption.evidence.example.json)
- [`reference-network-adoption.production.env.example`](reference-network-adoption.production.env.example)
