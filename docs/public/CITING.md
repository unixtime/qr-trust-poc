...
work, please cite the published paper that defines its trust-model foundation.
...
This repository contains subsequent implementation and evaluation work, so the
paper and software should not be treated as identical artifacts.
